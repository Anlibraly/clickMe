...
let modelAllowType = [Number, Boolean, String, Array];
let valueTransform = {
    encode: {
        Number: (val) => +val || 0,
        Boolean: (val) => val ? 1 : 0,
...
module.exports = {
    ...
    modelValueFilter (mod, record, complete) {
        ...
        _.each(keys, (v) => {
            ...
            } else if (_.isObject(mod[v])) {

                result[v] = mod[v].default;
